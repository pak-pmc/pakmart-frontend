      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-primary-foreground/80 text-sm">info@buildmart.com</p>
          </div>
        </div>

        <div className="border-t border-primary-foreground/20 mt-6 pt-4 text-center">
          <p className="text-primary-foreground/60 text-xs">© 2024 BuildMart. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
