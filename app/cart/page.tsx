...
import {useSendOrderAction} from "@/src/actions/SendOrderAction";
...
export default function CartPage() {
    ...
    const {sendOrder, isPending, data, error, successResponse} = useSendOrderAction();
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <form onSubmit={handleSubmit}>
                                    ...
                                    <CardContent className="space-y-4 m-4">
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                placeholder="Your city. eg: Accra"
                                                required
                                                className="mt-1"/>
                                        </div>
                                        <div>
                                ...
                                {successResponse && hasSubmitted && !isPending && (
                                    <Alert className="border-green-400 mt-3">
                                        <AlertTitle>Order Placed successfully</AlertTitle>
                                        <AlertDescription>
                                            An agent will contact you shortly to confirm your order. Thank you for
                                            shopping with us!
                                        </AlertDescription>
                                    </Alert>
                                )}
                                {hasSubmitted && !successResponse && (error || (data && !data.success)) && !isPending && (
                                    <Alert variant="destructive" className="mt-3">
                                        <AlertTitle>Order could not be completed.</AlertTitle>
                                        <AlertDescription>
                                            There was an error submitting your order. Please check your details and try
                                            again
                                        </AlertDescription>
                                    </Alert>
                                )}
